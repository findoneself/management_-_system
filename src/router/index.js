...
Vue.use(VueRouter)
    // 路由组件
const Login = () =>
    import ('_vie/login/Login')
const Main = () =>
    import ('_vie/main/Main')
const Home = () =>
    import ('_vie/main/home/Home')
const Dustmonitoring = () =>
    import ('_vie/main/dustMonitoring/DustMonitoring')
const Noisemonitoring = () =>
    import ('_vie/main/noiseMonitoring/NoiseMonitoring')
const Carwashing = () =>
    import ('_vie/main/carWashing/CarWashing')
const AIdistinguish = () =>
    import ('_vie/main/AIdistinguish/AIdistinguish')
const Projectmanagement = () =>
    import ('_vie/main/projectManagement/ProjectManagement')
const Patrolrectification = () =>
    import ('_vie/main/patrolRectification/PatrolRectification')
