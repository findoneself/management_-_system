...
function getMenuData (to, next) {
  ...
  $http({ url: `/menu/nav${to.params.userId || ''}` }).then(data => {
    ...
    const list = [
      ...
      { id: '4', key: 4, type: 'cat', catType: 'sub', title: '车洗裸土', parentId: '00' },
      { id: '4-1', key: 1, type: 'menu', title: 'AI识别安装率', parentId: '4', url: '@/AIdistinguish/children/vue1' },
      { id: '4-2', key: 2, type: 'menu', title: '测试2', parentId: '4', url: '@/AIdistinguish/children/vue2' },
      { id: '4-3', key: 3, type: 'menu', title: '测试3', parentId: '4', url: '@/AIdistinguish/children/vue3' },
      { id: '4-4', key: 4, type: 'menu', title: '测试4', parentId: '4', url: '@/AIdistinguish/children/vue4' },
