    ...
    getWarnInfo () {
      ...
      this.$http({
        ...
        const list = [
          ...
          { id: '145452', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
          { id: '1256', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
          { id: '1565232', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
          { id: '15652445', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
          { id: '156222', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
          { id: '15652565', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
          { id: '1565323232', num: 45, datetime: '2022-02-02 12:00:00', warnTypeName: 'pm2.5' },
